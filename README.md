...
### Windows
1. Download `GraphXR Viewer Setup 3.7.0.exe` from the releases page
2. Run the installer and follow the setup wizard
3. The application will be installed and shortcuts created

### Portable Version
1. Download `GraphXR Viewer-3.7.0-win.zip` from the releases page
...
1. Download the appropriate package:
   ...
   - Debian: `graphxr-viewer_3.7.0_arm64.deb`
2. For AppImage: Make executable and run
3. For DEB: Install with `sudo dpkg -i graphxr-viewer_3.7.0_arm64.deb`
